...
namespace Filuet.ASC.Kiosk.OnBoard.UVS.Core.Entities
{
    public partial class UvsDataEntities : DbContext
    {
        ...
        //public virtual int MarkGroupByPLUId(Nullable<int> pOSId, Nullable<int> pluId)
        //{
        ...
        //public virtual ObjectResult<rq_ReadPreke_Result> rq_ReadPreke(Nullable<int> prekesID, Nullable<int> bitoNr)
        //{
        ...
        //public virtual ObjectResult<rq_ScanKasininkaiByDep_Result> rq_ScanKasininkaiByDep(Nullable<int> dep)
        //{
        ...
        //public virtual ObjectResult<rq_ScanPrekesByDep_Result> rq_ScanPrekesByDep(Nullable<int> dep)
        //{
        //    var depParameter = dep.HasValue ?
        //        new ObjectParameter("dep", dep) :
        //        new ObjectParameter("dep", typeof(int));
        ...
        //public virtual int rq_SetBitByVal(Nullable<int> baitas, Nullable<int> bitas, Nullable<int> bval, ObjectParameter data)
        //{
        ...
        //public virtual int rq_SetPOSBits(Nullable<int> pOSId)
        //{
        //    var pOSIdParameter = pOSId.HasValue ?
        //        new ObjectParameter("POSId", pOSId) :
        //        new ObjectParameter("POSId", typeof(int));
        ...
        //public virtual int rq_SetPOSBitsPictures(Nullable<int> pOSId)
        //{
        //    var pOSIdParameter = pOSId.HasValue ?
        //        new ObjectParameter("POSId", pOSId) :
        //        new ObjectParameter("POSId", typeof(int));
        ...
        //public virtual int rq_StoreAnnulHead(Nullable<int> pOSId, Nullable<int> idOnPos, Nullable<int> checkNr, Nullable<int> zNr, Nullable<int> cashierId, Nullable<System.DateTime> annulTime, Nullable<int> annulType, ObjectParameter iD)
        //{
        //    var pOSIdParameter = pOSId.HasValue ?
        //        new ObjectParameter("POSId", pOSId) :
        //        new ObjectParameter("POSId", typeof(int));
        ...
        //public virtual int rq_StoreAnnulLine(Nullable<int> headId, Nullable<int> lineNumber, Nullable<double> price, Nullable<double> amount, Nullable<double> count, Nullable<double> discount, Nullable<double> vatAmount, Nullable<int> vatType, string barCode, Nullable<double> packCount, Nullable<double> realPrice, Nullable<int> priceOption, ObjectParameter iD)
        //{
        ...
        //public virtual int rq_StoreAparatasVersion(Nullable<int> apId, string version, string fiskalNr, string fiskalVersion)
        //{
        ...
        //public virtual int rq_StoreAparatasVersionHw(Nullable<int> apId, string version, string fiskalNr, string fiskalVersion, string cPUName, Nullable<int> cPUFreq, string hardDriveModel, string hardDriveSerial, Nullable<double> hardDriveSize_Mb, string videoName, Nullable<int> videoRAM_Kb, Nullable<int> rAM_Mb)
        //{
        //    var apIdParameter = apId.HasValue ?
        //        new ObjectParameter("ApId", apId) :
        //        new ObjectParameter("ApId", typeof(int));
        ...
        //public virtual int rq_StoreCashierLog(Nullable<int> cashierId, Nullable<int> aparatoId, Nullable<System.DateTime> logOnTime, Nullable<System.DateTime> logOffTime, Nullable<int> idOnPos, ObjectParameter iD)
        //{
        //    var cashierIdParameter = cashierId.HasValue ?
        //        new ObjectParameter("CashierId", cashierId) :
        //        new ObjectParameter("CashierId", typeof(int));
        ...
        //public virtual int rq_StoreCouponActivate(Nullable<int> idOnPos, Nullable<int> pOSId, Nullable<System.DateTime> opTime, Nullable<double> balance, Nullable<int> cashierId, Nullable<int> receiptNr, string couponNumber, Nullable<int> clientId, ObjectParameter iD)
        //{
        //    var idOnPosParameter = idOnPos.HasValue ?
        //        new ObjectParameter("IdOnPos", idOnPos) :
        //        new ObjectParameter("IdOnPos", typeof(int));
        ...
        //public virtual int rq_StoreEuroStage(Nullable<int> posId, Nullable<int> stageNr, Nullable<System.DateTime> when)
        //{
        //    var posIdParameter = posId.HasValue ?
        //        new ObjectParameter("PosId", posId) :
        //        new ObjectParameter("PosId", typeof(int));
        ...
        //public virtual int rq_StoreInactivityTime(Nullable<int> kvitoEiluteId, Nullable<double> duration, ObjectParameter iD)
        //{
        ...
        //public virtual int rq_StoreInkasac(Nullable<int> idOnPos, Nullable<int> pOSId, Nullable<System.DateTime> opTime, Nullable<double> amount, Nullable<int> opType, Nullable<int> zNr, Nullable<int> cashierId, ObjectParameter iD)
        //{
        //    var idOnPosParameter = idOnPos.HasValue ?
        //        new ObjectParameter("IdOnPos", idOnPos) :
        //        new ObjectParameter("IdOnPos", typeof(int));
        ...
        //public virtual int rq_StoreInkasacEx(Nullable<int> idOnPos, Nullable<int> pOSId, Nullable<System.DateTime> opTime, Nullable<double> amount, Nullable<int> opType, Nullable<int> zNr, Nullable<int> cashierId, string opName, string objId, string objName, ObjectParameter iD)
        //{
        //    var idOnPosParameter = idOnPos.HasValue ?
        //        new ObjectParameter("IdOnPos", idOnPos) :
        //        new ObjectParameter("IdOnPos", typeof(int));
        ...
        //public virtual int rq_StoreKvitoEilute(Nullable<int> galvosID, Nullable<int> prekesKodas, Nullable<double> kiekis, Nullable<double> kaina, Nullable<double> suma, Nullable<double> mokesciai, Nullable<double> nuolaida, Nullable<int> prekesID, string barkodas, Nullable<double> vietDez, Nullable<double> savikaina, Nullable<double> realKaina, Nullable<int> priceOption, Nullable<int> vAT, Nullable<int> sellFlags, Nullable<int> lineNumber, ObjectParameter iD)
        //{
        ...
        //public virtual int rq_StoreKvitoEiluteEx(Nullable<int> galvosID, Nullable<int> prekesKodas, Nullable<double> kiekis, Nullable<double> kaina, Nullable<double> suma, Nullable<double> mokesciai, Nullable<double> nuolaida, Nullable<int> prekesID, string barkodas, Nullable<double> vietDez, Nullable<double> savikaina, Nullable<double> realKaina, Nullable<int> priceOption, Nullable<int> vAT, Nullable<int> sellFlags, Nullable<int> lineNumber, Nullable<double> duration, Nullable<short> priceType, ObjectParameter iD)
        //{
        //    var galvosIDParameter = galvosID.HasValue ?
        //        new ObjectParameter("GalvosID", galvosID) :
        //        new ObjectParameter("GalvosID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoEiluteEx2(Nullable<int> galvosID, Nullable<int> prekesKodas, Nullable<double> kiekis, Nullable<double> kaina, Nullable<double> suma, Nullable<double> mokesciai, Nullable<double> nuolaida, Nullable<int> prekesID, string barkodas, Nullable<double> vietDez, Nullable<double> savikaina, Nullable<double> realKaina, Nullable<int> priceOption, Nullable<int> vAT, Nullable<int> sellFlags, Nullable<int> lineNumber, Nullable<double> duration, Nullable<short> priceType, string priceOriginType, Nullable<long> priceIdentificator, ObjectParameter iD)
        //{
        //    var galvosIDParameter = galvosID.HasValue ?
        //        new ObjectParameter("GalvosID", galvosID) :
        //        new ObjectParameter("GalvosID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoEiluteEx3(Nullable<int> galvosID, Nullable<int> prekesKodas, Nullable<double> kiekis, Nullable<double> kaina, Nullable<double> suma, Nullable<double> mokesciai, Nullable<double> nuolaida, Nullable<int> prekesID, string barkodas, Nullable<double> vietDez, Nullable<double> savikaina, Nullable<double> realKaina, Nullable<int> priceOption, Nullable<int> vAT, Nullable<int> sellFlags, Nullable<int> lineNumber, Nullable<double> duration, Nullable<short> priceType, string priceOriginType, Nullable<long> priceIdentificator, string packerId, ObjectParameter iD)
        //{
        //    var galvosIDParameter = galvosID.HasValue ?
        //        new ObjectParameter("GalvosID", galvosID) :
        //        new ObjectParameter("GalvosID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoGalva(Nullable<int> aparatoID, Nullable<int> kvitoNr, Nullable<short> year, Nullable<byte> month, Nullable<byte> day, Nullable<byte> hour, Nullable<byte> minute, Nullable<byte> apmokejimoRusis, Nullable<double> suma, Nullable<double> nuolaida, Nullable<double> antkainis, Nullable<double> mokesciai, string kortelesNr, Nullable<int> kasininkas, Nullable<int> znr, string kvitoNr2, string nlKort, Nullable<double> sumaGryni, ObjectParameter iD)
        //{
        //    var aparatoIDParameter = aparatoID.HasValue ?
        //        new ObjectParameter("AparatoID", aparatoID) :
        //        new ObjectParameter("AparatoID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoGalvaEx(Nullable<int> aparatoID, Nullable<int> kvitoNr, Nullable<short> year, Nullable<byte> month, Nullable<byte> day, Nullable<byte> hour, Nullable<byte> minute, Nullable<byte> apmokejimoRusis, Nullable<double> suma, Nullable<double> nuolaida, Nullable<double> antkainis, Nullable<double> mokesciai, string kortelesNr, Nullable<int> kasininkas, Nullable<int> znr, string kvitoNr2, string nlKort, Nullable<double> sumaGryni, Nullable<byte> seconds, Nullable<double> duration, Nullable<double> durationToPushTotal, ObjectParameter iD)
        //{
        //    var aparatoIDParameter = aparatoID.HasValue ?
        //        new ObjectParameter("AparatoID", aparatoID) :
        //        new ObjectParameter("AparatoID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoGalvaEx2(Nullable<int> aparatoID, Nullable<int> kvitoNr, Nullable<short> year, Nullable<byte> month, Nullable<byte> day, Nullable<byte> hour, Nullable<byte> minute, Nullable<byte> apmokejimoRusis, Nullable<double> suma, Nullable<double> nuolaida, Nullable<double> antkainis, Nullable<double> mokesciai, string kortelesNr, Nullable<int> kasininkas, Nullable<int> znr, string kvitoNr2, string nlKort, Nullable<double> sumaGryni, Nullable<byte> seconds, Nullable<double> duration, Nullable<double> durationToPushTotal, Nullable<int> flags, ObjectParameter iD)
        //{
        //    var aparatoIDParameter = aparatoID.HasValue ?
        //        new ObjectParameter("AparatoID", aparatoID) :
        //        new ObjectParameter("AparatoID", typeof(int));
        ...
        //public virtual int rq_StoreKvitoGalvaEx3(Nullable<int> aparatoID, Nullable<int> kvitoNr, Nullable<short> year, Nullable<byte> month, Nullable<byte> day, Nullable<byte> hour, Nullable<byte> minute, Nullable<byte> apmokejimoRusis, Nullable<double> suma, Nullable<double> nuolaida, Nullable<double> antkainis, Nullable<double> mokesciai, string kortelesNr, Nullable<int> kasininkas, Nullable<int> znr, string kvitoNr2, string nlKort, Nullable<double> sumaGryni, Nullable<byte> seconds, Nullable<double> duration, Nullable<double> durationToPushTotal, Nullable<int> flags, string invNr, ObjectParameter iD)
        //{
        //    var aparatoIDParameter = aparatoID.HasValue ?
        //        new ObjectParameter("AparatoID", aparatoID) :
        //        new ObjectParameter("AparatoID", typeof(int));
        ...
        //public virtual int rq_StorePayment(Nullable<int> galvosId, Nullable<int> type, Nullable<double> amount, string cardNo, string authCode, Nullable<int> authModule, Nullable<double> currencyRate, Nullable<double> currencyAmount, ObjectParameter iD)
        //{
        //    var galvosIdParameter = galvosId.HasValue ?
        //        new ObjectParameter("GalvosId", galvosId) :
        //        new ObjectParameter("GalvosId", typeof(int));
        ...
        //public virtual int rq_StorePaymentBank(Nullable<int> paymentId, Nullable<short> bankId, Nullable<short> bankOwnerId, Nullable<bool> isCobrand, Nullable<bool> isOnline, ObjectParameter iD)
        //{
        ...
        //public virtual int rq_StorePaymentBank2(Nullable<int> paymentId, Nullable<short> bankId, Nullable<short> bankOwnerId, Nullable<bool> isCobrand, Nullable<bool> isOnline, string authId, string ci, ObjectParameter iD)
        //{
        //    var paymentIdParameter = paymentId.HasValue ?
        //        new ObjectParameter("PaymentId", paymentId) :
        //        new ObjectParameter("PaymentId", typeof(int));
        ...
        //public virtual int rq_StorePoints_Headers(Nullable<int> galvosId, Nullable<double> points, Nullable<double> centerPoints, Nullable<int> discountIdentificator, ObjectParameter iD)
        //{
        //    var galvosIdParameter = galvosId.HasValue ?
        //        new ObjectParameter("GalvosId", galvosId) :
        //        new ObjectParameter("GalvosId", typeof(int));
        ...
        //public virtual int rq_StorePoints_Items(Nullable<int> kvitoEiluteId, Nullable<double> points, Nullable<int> discountIdentificator, ObjectParameter iD)
        //{
        //    var kvitoEiluteIdParameter = kvitoEiluteId.HasValue ?
        //        new ObjectParameter("KvitoEiluteId", kvitoEiluteId) :
        //        new ObjectParameter("KvitoEiluteId", typeof(int));
        ...
        //public virtual int rq_StorePrice_Discounts_Items(Nullable<int> kvitoEiluteId, Nullable<double> discount, Nullable<int> discountScenarioType, Nullable<int> discountIdentificator, Nullable<int> sellDiscountId, ObjectParameter iD)
        //{
        //    var kvitoEiluteIdParameter = kvitoEiluteId.HasValue ?
        //        new ObjectParameter("KvitoEiluteId", kvitoEiluteId) :
        //        new ObjectParameter("KvitoEiluteId", typeof(int));
        ...
        //public virtual int rq_StoreReward(Nullable<int> galvosId, Nullable<int> discountIdentificator, string rewardIdentificator, string couponBarcode, Nullable<bool> isGsm, Nullable<short> quantity, ObjectParameter iD)
        //{
        //    var galvosIdParameter = galvosId.HasValue ?
        //        new ObjectParameter("GalvosId", galvosId) :
        //        new ObjectParameter("GalvosId", typeof(int));
        ...
        //public virtual int rq_StoreSellDiscount(Nullable<int> galvosId, Nullable<int> type, Nullable<int> subType, Nullable<int> custNo, Nullable<double> percent, Nullable<double> amount, string cardNo, string discountTitle, ObjectParameter iD)
        //{
        //    var galvosIdParameter = galvosId.HasValue ?
        //        new ObjectParameter("GalvosId", galvosId) :
        //        new ObjectParameter("GalvosId", typeof(int));
        ...
        //public virtual int rq_StoreSellEntry(Nullable<int> galvosId, Nullable<int> sellLine, Nullable<int> entryCode, string entry, ObjectParameter iD)
        //{
        //    var galvosIdParameter = galvosId.HasValue ?
        //        new ObjectParameter("GalvosId", galvosId) :
        //        new ObjectParameter("GalvosId", typeof(int));
        ...
        //public virtual int rq_StoreStartParam(Nullable<int> apID, Nullable<int> zNR, Nullable<int> kVNR)
        //{
        //    var apIDParameter = apID.HasValue ?
        //        new ObjectParameter("apID", apID) :
        //        new ObjectParameter("apID", typeof(int));
        ...
        //public virtual int rq_SwapBits(Nullable<int> bitonr, ObjectParameter data1, ObjectParameter data2)
        //{
        //    var bitonrParameter = bitonr.HasValue ?
        //        new ObjectParameter("bitonr", bitonr) :
        //        new ObjectParameter("bitonr", typeof(int));
        ...
        //public virtual int sco_ClearBit(Nullable<int> bitonr, ObjectParameter data1)
        //{
        //    var bitonrParameter = bitonr.HasValue ?
        //        new ObjectParameter("bitonr", bitonr) :
        //        new ObjectParameter("bitonr", typeof(int));
        ...
        //public virtual int sco_ClearBits(Nullable<int> bitoNr, string ids, string tableName, string fieldName, string iDfieldName)
        //{
        //    var bitoNrParameter = bitoNr.HasValue ?
        //        new ObjectParameter("BitoNr", bitoNr) :
        //        new ObjectParameter("BitoNr", typeof(int));
        ...
        //public virtual int sco_PrekesTransferBit(Nullable<int> prekesID, Nullable<int> bitonr, Nullable<int> deleteoperation)
        //{
        //    var prekesIDParameter = prekesID.HasValue ?
        //        new ObjectParameter("PrekesID", prekesID) :
        //        new ObjectParameter("PrekesID", typeof(int));
        ...
        //public virtual ObjectResult<sco_ReadCashier_Result> sco_ReadCashier(Nullable<int> cashierID, Nullable<int> bitoNr)
        //{
        //    var cashierIDParameter = cashierID.HasValue ?
        //        new ObjectParameter("CashierID", cashierID) :
        //        new ObjectParameter("CashierID", typeof(int));
        ...
        //public virtual int sco_ReadCatPict(Nullable<int> catPictID, Nullable<int> bitoNr)
        //{
        ...
        //public virtual ObjectResult<sco_ReadLoyCard_Result> sco_ReadLoyCard(Nullable<int> loyCardID, Nullable<int> bitoNr)
        //{
        ...
        //public virtual int sco_ReadPLUPict(Nullable<int> pLUPictID, Nullable<int> bitoNr)
        //{
        ...
        //public virtual ObjectResult<sco_ReadPreke_Result> sco_ReadPreke(Nullable<int> prekesID, Nullable<int> bitoNr, Nullable<int> dep)
        //{
        //    var prekesIDParameter = prekesID.HasValue ?
        //        new ObjectParameter("PrekesID", prekesID) :
        //        new ObjectParameter("PrekesID", typeof(int));
        ...
        //public virtual ObjectResult<sco_ReadPrekeDelete_Result> sco_ReadPrekeDelete(Nullable<int> prekesID, Nullable<int> bitoNr, Nullable<int> dep)
        //{
        //    var prekesIDParameter = prekesID.HasValue ?
        //        new ObjectParameter("PrekesID", prekesID) :
        //        new ObjectParameter("PrekesID", typeof(int));
        ...
        //public virtual int StorePLUSetPaid(string bC, Nullable<int> kGID)
        //{
